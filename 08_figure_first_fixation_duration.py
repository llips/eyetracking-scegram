"""
Create histogram of first fixation duration by category
"""
import pandas as pd
...
plot(data, data_std, category=category, variable=variable, ylabel=ylabel, ymax=3, filename=fname.figure_first_fixation_duration_roi(block=args.block))